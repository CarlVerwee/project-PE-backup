...
void ButtonPressed_Dev1(uint8_t *button);
void ButtonPressed_Dev2(uint8_t *button);
void ButtonPressed_Dev3(uint8_t *button);
void ButtonPressed_Dev4(uint8_t *button);
