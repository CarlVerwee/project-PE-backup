...
#define TIM_PWM_CARRIER htim4
#define TIM_PWM_CARRIER_CHANNEL TIM_CHANNEL_3

/* Some Application variables -------------------------------*/
uint16_t tijd[60][500]; //60 verschillende commando's met elk 500 tijseenheden die het commando(signaal) beschrijven
...
void IR_UNDERSTAND()
{
	...
	//if(tijd[commando][1-5=0 dan is er geen signaal, lees opnieuw tot je signaal hebt ])
...
void IR_sent()
{
   ...
   {
//	   if(tijd[commando][i] == 0)
//	   {
//		   //de volgende!
//		   printf("%d de volgende\r\n ", i);
//		   IR_Carrier_OFF();
//		   i++;
//
//	   }
